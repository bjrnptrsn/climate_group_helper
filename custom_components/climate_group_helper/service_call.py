...
class ServiceCallHandler:
    ...
    - Debounce rapid calls to prevent network flooding
    - Retry failed calls (configurable attempts + delay)
    - Track command source for sync block (group vs member origin)
    """
